...
class GraphState(TypedDict):
    ...
    # ── 分析Agent主动协作: 信息需求与回退计数 ──
    analysis_info_request: Sequence[dict]
    analysis_rollback_count: int
    max_analysis_rollback: int

    # ── 时间统计和全链路日志 ──
    timings: dict[str, float]
    execution_logs: Sequence[dict]
    decision_logs: Sequence[dict]
